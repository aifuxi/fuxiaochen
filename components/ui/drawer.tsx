      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          `
            ...
            data-[vaul-drawer-direction=bottom]:rounded-t-md data-[vaul-drawer-direction=bottom]:border-t
            ...
            data-[vaul-drawer-direction=top]:rounded-b-md data-[vaul-drawer-direction=top]:border-b
