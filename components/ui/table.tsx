...
export function Table({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn("overflow-hidden rounded-[1.6rem] border border-white/8 bg-white/3", className)} {...props} />
  );
}

export function TableRoot({ className, ...props }: React.TableHTMLAttributes<HTMLTableElement>) {
...
export function TableHeaderCell({ className, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <th
      className={cn("px-5 py-3 font-mono text-[11px] font-medium tracking-[0.28em] text-muted uppercase", className)}
      {...props}
    />
  );
}
...
export function TableCell({ className, ...props }: React.TdHTMLAttributes<HTMLTableCellElement>) {
  return <td className={cn("px-5 py-4 text-sm text-foreground", className)} {...props} />;
}
