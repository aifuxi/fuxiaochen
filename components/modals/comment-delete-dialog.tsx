...
export const CommentDeleteDialog = NiceModal.create(({ comment, onConfirm }: CommentDeleteDialogProps) => {
    ...
    <Dialog open={modal.visible} onOpenChange={modal.remove}>
      ...
      `}>
        <DialogHeader>
          ...
          <DialogDescription>
            Remove <span className="text-foreground">{comment.authorName}</span>&apos;s comment from the moderation queue.
          </DialogDescription>
        </DialogHeader>
