...
export const ChangelogDeleteDialog = NiceModal.create(({ onConfirm, release }: ChangelogDeleteDialogProps) => {
    ...
    <Dialog open={modal.visible} onOpenChange={modal.remove}>
      ...
      `}>
        <DialogHeader>
          ...
          <DialogDescription>
            Remove <span className="text-foreground">{release.version}</span> from the changelog timeline.
          </DialogDescription>
        </DialogHeader>
