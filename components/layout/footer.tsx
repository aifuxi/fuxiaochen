      ...
      <div className={`relative mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16`}>
        ...
        >
          ...
          <div className={`flex flex-col items-center gap-4 md:items-start`}>
            ...
            <p
              className={`max-w-xs text-center text-sm text-text-secondary md:text-left`}
            >
              {SLOGAN}
            </p>
              ...
              {socialLinks.map((item) => {
                ...
                return (
                  <a
                    ...
                    className={`flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-text-secondary transition-all duration-200 hover:border-accent/30 hover:text-accent`}
          ...
          <div className={`flex flex-col items-center gap-6 md:items-end`}>
            ...
            {/* 备案信息 */}
            <div
              className={`flex flex-col items-center gap-2 text-xs text-text-tertiary md:flex-row md:gap-4`}
            >
              <span>
                © {currentYear} {WEBSITE}
              </span>
