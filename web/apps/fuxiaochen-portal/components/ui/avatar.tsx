    ...
    <AvatarPrimitive.Root
      ...
      className={cn(
        `
          ...
          after:border-border after:absolute after:inset-0 after:rounded-full after:border after:mix-blend-darken
...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        `
          bg-primary text-primary-foreground ring-background absolute right-0 bottom-0 z-10 inline-flex items-center
