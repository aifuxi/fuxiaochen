...
export const siteCopy = {
  ...
  blogPost: {
    ...
    backToBlog: "返回博客",
    similarTitle: "相关文章",
    likeCtaTitle: "觉得这篇文章有帮助？",
    likeCtaDescription: "点个赞，我会知道这类内容值得继续写。",
    likeCtaLikedDescription: "已收到你的喜欢，感谢反馈。",
    likeCtaAction: "点赞支持",
    likeCtaLikedAction: "已点赞",
    copyCode: "复制",
    copiedCode: "已复制",
    copyCodeFailed: "复制失败",
  },
  comments: {
    ...
    replyAction: "回复",
    replyCancel: "取消回复",
    replyTitle: (author: string) => `回复 ${author}`,
