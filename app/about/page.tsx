  ...
  return (
    <div className="container flex flex-col space-y-8">
      ...
      <div className="prose max-w-none dark:prose-invert">
        ...
        <p>
          2020
          年毕业于南昌某不知名专科学院，学的是大数据技术与应用专业，也算是科班出身。虽然大多数人认为专科不大行，但不可否认的是，学校里的课程对我还是有一定帮助的。
        </p>
        <p>
          大一就开始学习的 Linux
          系统基础，即便到现在，也让我在工作和日常开发中受益良多。命令行工具、vim、前后端等项目的部署无一不都需要
          Linux 的知识。
        </p>
        <p>
          还有 Python、网页设计与开发、Java、数据库技术及应用
          MySQL、Hadoop、HBase
          等课程的学习，也让我拓宽了不少视野，让我在工作和聊天水群提供了一定的技术基础。🤪
        </p>
        <p>
          大三，学校获批成为 ”1+X“Web
          前端开发职业技能等级证书考核站点，由此开展了免费的前端训练营。请校外的讲师来学校给我们专门讲解前端技术，让我们去考这个
          Web 前端开发职业技能等级证书，
