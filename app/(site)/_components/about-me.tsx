...
export function AboutMe() {
  return (
    <div className="py-20 relative min-h-[600px]">
      <div className="absolute top-40 -skew-y-[3deg] inset-x-0  -z-[1] min-h-[700px]  md:min-h-[400px] pointer-events-none bg-primary"></div>
